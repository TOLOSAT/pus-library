...
extern pusStatus_t PushActivityInSchedule(deviceNo_t schedule_deviceno, pusActivity_t *activity);
extern pusStatus_t PopActivityInSchedule(deviceNo_t schedule_deviceno, pusActivity_t *activity);
